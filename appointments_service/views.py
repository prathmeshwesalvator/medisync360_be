...
class BookAppointmentView(APIView):
    ...
    def post(self, request):
        ...
        return success_response(data=AppointmentDetailSerializer(appt).data,
            message='Appointment booked.', status_code=201)
...
class MyAppointmentsView(APIView):
    ...
    def get(self, request):
        ...
        qs = Appointment.objects.filter(patient=request.user).select_related('doctor__user','hospital')
        if status_filter:
...
class AppointmentDetailView(APIView):
    ...
    def _get(self, request, pk):
        try:
            ...
            return None
        # Patient, doctor, or hospital can view
        user = request.user
    ...
    def get(self, request, pk):
        ...
        if not appt: return error_response('Appointment not found.', status_code=404)
        return success_response(data=AppointmentDetailSerializer(appt).data)
...
class CancelAppointmentView(APIView):
    ...
    def post(self, request, pk):
        ...
        try:
            ...
            return error_response(str(e))
        return success_response(data=AppointmentDetailSerializer(appt).data, message='Appointment cancelled.')
...
class RescheduleAppointmentView(APIView):
    ...
    def post(self, request, pk):
        ...
        try:
            ...
            return error_response(str(e))
        return success_response(data=AppointmentDetailSerializer(appt).data, message='Appointment rescheduled.')
...
class MarkPaidView(APIView):
    ...
    def post(self, request, pk):
        ...
        appt = mark_paid(appt)
        return success_response(data=AppointmentDetailSerializer(appt).data, message='Payment recorded.')
...
class CompleteAppointmentView(APIView):
    ...
    def post(self, request, pk):
        try:
            ...
            return error_response('Appointment not found.', status_code=404)
        if appt.status != 'confirmed' and appt.status != 'rescheduled':
        ...
        return success_response(data=AppointmentDetailSerializer(appt).data, message='Appointment completed.')